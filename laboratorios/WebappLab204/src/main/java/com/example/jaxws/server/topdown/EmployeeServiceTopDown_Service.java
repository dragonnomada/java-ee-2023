 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceTopDown", targetNamespace = "http://topdown.server.jaxws.example.com/", wsdlLocation = "file:/D:/jee-workship/workspace/webservices/employeeservicetopdown.wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICETOPDOWN_QNAME = new QName("http://topdown.server.jaxws.example.com/", "EmployeeServiceTopDown");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/jee-workship/workspace/webservices/employeeservicetopdown.wsdl");
    ...
    public EmployeeServiceTopDown getEmployeeServiceTopDownSOAP() {
        return super.getPort(new QName("http://topdown.server.jaxws.example.com/", "EmployeeServiceTopDownSOAP"), EmployeeServiceTopDown.class);
    }
    ...
    public EmployeeServiceTopDown getEmployeeServiceTopDownSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://topdown.server.jaxws.example.com/", "EmployeeServiceTopDownSOAP"), EmployeeServiceTopDown.class, features);
    }
